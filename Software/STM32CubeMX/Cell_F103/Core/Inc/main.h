...
#define AN_ALRT1_Pin GPIO_PIN_5
#define AN_ALRT1_GPIO_Port GPIOB
#define AN_ALRT1_EXTI_IRQn EXTI9_5_IRQn
#define CAN_ALRT2_Pin GPIO_PIN_6
#define CAN_ALRT2_GPIO_Port GPIOB
#define CAN_ALRT2_EXTI_IRQn EXTI9_5_IRQn
#define CAN_ALRT1_Pin GPIO_PIN_7

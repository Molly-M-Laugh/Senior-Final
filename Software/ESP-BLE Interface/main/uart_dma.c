 ...
 *
 * GPIO — ⚠️ CONFIRM against CANESP schematic:
 *   TX: GPIO_NUM_17   ⚠️ CONFIRM  (connects to NETESP RX)
 *   RX: GPIO_NUM_16   ⚠️ CONFIRM  (connects to NETESP TX)
 *
...
#define UART_TX_GPIO            17          /* ⚠️ CONFIRM */
#define UART_RX_GPIO            16          /* ⚠️ CONFIRM */
